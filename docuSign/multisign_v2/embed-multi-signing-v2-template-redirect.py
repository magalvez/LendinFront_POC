...
def generate_template_role_business_owner_1():

    t_role = TemplateRole()
    t_role.role_name = 'Business Owner 1'
...
def generate_template_role_business_owner_2():

    t_role = TemplateRole()
    t_role.role_name = 'Business Owner 2'
...
def generate_template_role_business_owner_3():

    t_role = TemplateRole()
    t_role.role_name = 'Business Owner 3'
    t_role.name = 'Manuel Galvez'
    t_role.email = 'magalvezc@lendinfront.com'
...
def generate_template_role_business_owner_4():

    t_role = TemplateRole()
    t_role.role_name = 'Business Owner 4'
    t_role.name = 'Jonathan Vallejo'
    t_role.email = 'jvallejo@lendinfront.com'
...
def generate_template_role_business_guarantor_1():

    t_role = TemplateRole()
    t_role.role_name = 'Business Guarantor 1'
    t_role.name = 'B Guarantor 1'
    t_role.email = 'bguarantor1@lendinfront.com'
...
def generate_template_role_business_guarantor_2():

    t_role = TemplateRole()
    t_role.role_name = 'Business Guarantor 2'
    t_role.name = 'B Guarantor 2'
    t_role.email = 'bguarantor2@lendinfront.com'
    t_role.client_user_id = '54657686'
    t_role.routing_order = '1'

    return t_role

def generate_template_role_business_guarantor_3():

    t_role = TemplateRole()
    t_role.role_name = 'Business Guarantor 3'
    t_role.name = 'B Guarantor 3'
    t_role.email = 'bguarantor3@lendinfront.com'
    t_role.client_user_id = '54657687'
    t_role.routing_order = '1'

    return t_role

def generate_template_role_business_guarantor_4():

    t_role = TemplateRole()
    t_role.role_name = 'Business Guarantor 4'
    t_role.name = 'B Guarantor 4'
    t_role.email = 'bguarantor4@lendinfront.com'
    t_role.client_user_id = '54657688'
    t_role.routing_order = '1'

    return t_role


def generate_template_role_guarantor_1():

    t_role = TemplateRole()
    t_role.role_name = 'Guarantor 1'
    t_role.name = 'Juan Sebastian Fernandez'
    t_role.email = 'checho@lendinfront.com'
    t_role.client_user_id = '54657689'
    t_role.routing_order = '1'
...
def generate_template_role_guarantor_2():
    ...
    t_role.client_user_id = '54657690'
    t_role.routing_order = '1'
...
def generate_template_role_guarantor_3():
    ...
    t_role.client_user_id = '54657691'
    t_role.routing_order = '1'

    return t_role


def generate_template_role_guarantor_4():

    t_role = TemplateRole()
    t_role.role_name = 'Guarantor 4'
    t_role.name = 'Grigor Dimitrov'
    t_role.email = 'grigord@lendinfront.com'
    t_role.client_user_id = '54657692'
    t_role.routing_order = '1'

    return t_role


def generate_envelop(env_def, envelope_api, role_1, role_2, role_3, role_4):

    env_def.template_roles = [role_1, role_2, role_3, role_4]
    env_def.status = 'sent'
...
def embedded_signing_ceremony():
    ...
    business_owner_role_1 = generate_template_role_business_owner_1()
    business_owner_role_2 = generate_template_role_business_owner_2()
    business_owner_role_3 = generate_template_role_business_owner_3()
    business_owner_role_4 = generate_template_role_business_owner_4()
    business_guarantor_role_1 = generate_template_role_business_guarantor_1()
    business_guarantor_role_2 = generate_template_role_business_guarantor_2()
    business_guarantor_role_3 = generate_template_role_business_guarantor_3()
    business_guarantor_role_4 = generate_template_role_business_guarantor_4()
    guarantor_role_1 = generate_template_role_guarantor_1()
    guarantor_role_2 = generate_template_role_guarantor_2()
    guarantor_role_3 = generate_template_role_guarantor_3()
    guarantor_role_4 = generate_template_role_guarantor_4()

    envelope_id = generate_envelop(env_def, envelope_api, business_owner_role_1, business_guarantor_role_2,
                                   business_guarantor_role_3, guarantor_role_4)
    #envelope_id = '4ea68e61-1ebc-4139-845f-3ec1f59645da'

    generate_recipient_view_request_by_role(envelope_id, envelope_api, business_owner_role_1)
    generate_recipient_view_request_by_role(envelope_id, envelope_api, business_guarantor_role_2)
    generate_recipient_view_request_by_role(envelope_id, envelope_api, business_guarantor_role_3)
    generate_recipient_view_request_by_role(envelope_id, envelope_api, guarantor_role_4)
